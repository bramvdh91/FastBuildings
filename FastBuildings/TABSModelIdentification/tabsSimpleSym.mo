...
model tabsSimpleSym
  "Simple tabs model using heat flow as input, and with a single resistance value for top and bottom layers and a single capacity value."

  parameter SI.HeatCapacity c = 1 "Thermal capacity of half slab";
