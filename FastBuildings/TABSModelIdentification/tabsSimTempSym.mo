...
model tabsSimTempSym "Simple tabs model using Pipe temperature as input, and with a single resistance value for top and bottom layers
  ...
  parameter SI.HeatCapacity c = 1
    "Thermal capacity of upper and lower slab separately";
